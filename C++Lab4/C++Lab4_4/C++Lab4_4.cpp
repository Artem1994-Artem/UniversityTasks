...
int main()
{
    ...
    str2 = (char*)calloc(10, 20);
    for (int i = 0; i < 10; i++) str1[i] = rand() % 26 + 'a';
    str1[10] = '\0';

    for (int i = 0; i < 10; i++) str2[i] = rand() % 26 + 'a';
    str2[10] = '\0';
    ...
    cout << "Результат сравнения до копирования:   " << sravn(str1, str2) << endl;
    kopir(str1, str2);
